...
<head>
    ...
    <title>{{ $user->name }} - Portfolio (Theme 3)</title>
    <link rel="stylesheet" href="{{ asset('front-assets/css/themes/theme1.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/css/themes/theme3.css') }}">
</head>

<body class="{{ LaravelLocalization::getCurrentLocale() == 'ar' ? 'rtl' : '' }} theme-3">
    <!-- Header -->
    <header>
        <nav>
