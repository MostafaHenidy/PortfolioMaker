...
<head>
    ...
    <title>{{ $user->name }} - Portfolio (Theme 4)</title>
    <link rel="stylesheet" href="{{ asset('front-assets/css/themes/theme1.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/css/themes/theme4.css') }}">
</head>

<body class="{{ LaravelLocalization::getCurrentLocale() == 'ar' ? 'rtl' : '' }} theme-4">
    <!-- Header -->
    <header>
        <nav>
