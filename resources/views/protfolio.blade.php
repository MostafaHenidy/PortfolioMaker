...
<body>
    ...
    <section id="contact">
        ...
        <div class="contact-container">
            <p>Have a project in mind or just want to say hello? Send me an email and I'll get back to you as soon as
                possible.</p>
            <form>
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; 2025 Jane Doe. Built with Laravel, Livewire, and love.</p>
    </footer>
</body>
