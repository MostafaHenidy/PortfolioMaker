    ...
    <div>
        <div class="card-body p-4 p-md-5" id="uploadSection">
            <h3 class="card-title mb-4 text-center fw-bold">
                <i class="fas fa-cloud-upload-alt text-primary"></i> Upload PDF
            </h3>
            ...
            <form wire:submit.prevent="save" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <div class="upload-input-wrapper">
                        <input type="file" wire:model="pdfFile" id="pdfInput" class="form-control form-control-lg"
                ...
                <button type="submit" class="btn btn-primary btn-lg w-100 mb-3 fw-semibold"
                    @if (!$pdfFile) disabled @endif wire:loading.attr="disabled" wire:target="upload">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            <div>
                <h5 class="d-block">Scan this QR Code</h5>
            </div>
            <div class="mb-3">
                {!! $qrCode !!}
            </div>
