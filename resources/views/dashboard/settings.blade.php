        ...
        <form class="pb-4" action="{{ route('dashboard.settings.update') }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2 form-switch">
                    ...
                    <input id="chk_about" class="form-check-input @if (LaravelLocalization::getCurrentLocale() == 'ar') ms-1 @endif"
                        type="checkbox" name="about" value="1" @checked($settings->about)>
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2 form-switch">
                    ...
                    <input id="chk_skills" class="form-check-input @if (LaravelLocalization::getCurrentLocale() == 'ar') ms-1 @endif"
                        type="checkbox" name="skills" value="1" @checked($settings->skills)>
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2 form-switch">
                    ...
                    <input id="chk_projects" class="form-check-input @if (LaravelLocalization::getCurrentLocale() == 'ar') ms-1 @endif"
                        type="checkbox" name="projects" value="1" @checked($settings->projects)>
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-2 form-switch">
                    ...
                    <input id="chk_contact" class="form-check-input @if (LaravelLocalization::getCurrentLocale() == 'ar') ms-1 @endif"
                        type="checkbox" name="contact" value="1" @checked($settings->contact)>
            ...
            <div class="row mb-3" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
                <div class="col-12">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <label class="border rounded-3 p-2 d-flex align-items-center"
                            ...
                            <input type="radio" name="theme_id" value="1"
                                class="form-check-input {{ app()->getLocale() === 'ar' ? 'ms-2' : 'me-2' }}"
                        ...
                        <label class="border rounded-3 p-2 d-flex align-items-center"
                            ...
                            <input type="radio" name="theme_id" value="5"
                                class="form-check-input {{ app()->getLocale() === 'ar' ? 'ms-2' : 'me-2' }}"
                        ...
                        <label class="border rounded-3 p-2 d-flex align-items-center"
                            ...
                            <input type="radio" name="theme_id" value="6"
                                class="form-check-input {{ app()->getLocale() === 'ar' ? 'ms-2' : 'me-2' }}"
                        ...
                        <label class="border rounded-3 p-2 d-flex align-items-center"
                            ...
                            <input type="radio" name="theme_id" value="7"
                                class="form-check-input {{ app()->getLocale() === 'ar' ? 'ms-2' : 'me-2' }}"
                        ...
                        <label class="border rounded-3 p-2 d-flex align-items-center"
                            ...
                            <input type="radio" name="theme_id" value="8"
                                class="form-check-input {{ app()->getLocale() === 'ar' ? 'ms-2' : 'me-2' }}"
                        ...
                        <label class="border rounded-3 p-2 d-flex align-items-center"
                            ...
                            <input type="radio" name="theme_id" value="9"
                                class="form-check-input {{ app()->getLocale() === 'ar' ? 'ms-2' : 'me-2' }}"
                        ...
                        <label class="border rounded-3 p-2 d-flex align-items-center"
                            style="cursor:pointer; min-width: 140px; background: #020617; color:#e5e7eb;">
                            <input type="radio" name="theme_id" value="10"
                                class="form-check-input {{ app()->getLocale() === 'ar' ? 'ms-2' : 'me-2' }}"
                                @checked($settings->theme_id == 10)>
                            <span>
                                {{ __('keywords.theme') }} 10
                                <span class="d-block mt-1"
